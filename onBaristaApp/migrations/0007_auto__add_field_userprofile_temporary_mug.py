...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.temporary_mug'
        db.add_column(u'onBaristaApp_userprofile', 'temporary_mug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.temporary_mug'
        db.delete_column(u'onBaristaApp_userprofile', 'temporary_mug')
    ...
    models = {
        ...
        u'onBaristaApp.userprofile': {
            ...
            'temporary_mug': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),

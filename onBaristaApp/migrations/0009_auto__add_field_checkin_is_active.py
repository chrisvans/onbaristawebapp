...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'checkIn.is_active'
        db.add_column(u'onBaristaApp_checkin', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'checkIn.is_active'
        db.delete_column(u'onBaristaApp_checkin', 'is_active')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.background_image'
        db.add_column(u'onBaristaApp_company', 'background_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.background_image'
        db.delete_column(u'onBaristaApp_company', 'background_image')

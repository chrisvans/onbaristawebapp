...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'onBaristaApp_userprofile', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='America/New_York', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.timezone'
        db.delete_column(u'onBaristaApp_userprofile', 'timezone')

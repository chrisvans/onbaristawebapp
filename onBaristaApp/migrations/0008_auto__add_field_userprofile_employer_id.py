...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.employer_id'
        db.add_column(u'onBaristaApp_userprofile', 'employer_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.employer_id'
        db.delete_column(u'onBaristaApp_userprofile', 'employer_id')
    ...
    models = {
        ...
        u'onBaristaApp.company': {
            ...
            'background_image': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        u'onBaristaApp.userprofile': {
            ...
            'employer_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'temporary_mug': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),

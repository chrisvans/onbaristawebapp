...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'companyLocation.background_image'
        db.delete_column(u'onBaristaApp_companylocation', 'background_image')


    def backwards(self, orm):
        # Adding field 'companyLocation.background_image'
        db.add_column(u'onBaristaApp_companylocation', 'background_image',

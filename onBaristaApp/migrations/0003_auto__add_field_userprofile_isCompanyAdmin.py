...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.isCompanyAdmin'
        db.add_column('onBaristaApp_userprofile', 'isCompanyAdmin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.isCompanyAdmin'
        db.delete_column('onBaristaApp_userprofile', 'isCompanyAdmin')
